...
/**
  * @desc  Focus.Presenter is a communication hub between views and models/collections
...
var Presenter = function(name, extended) {
    ...
    var Presenter = function(options) {
        ...
        Focus.presenterInstances[name] = this;
    ...
    if (extended && typeof extended.singleton !== "undefined" && !extended.singleton)
        ...
        if (!Focus.presenterInstances[name]) {
            return new Presenter(options);
        } else {
            return Focus.presenterInstances[name]._init(options);
        }
    };

};

Focus.Presenter = Presenter;
        ...
        if (typeof view === "object") {
            ...
            functions.forEach(function(fn) {
                if (typeof _this[fn] === 'function') {
                    ...
                    throw new Error('Binder->bindToView() requires an array of functions associated with a view, '+fn+' is not a valid method of presenter instance');
                }
            });
