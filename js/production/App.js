...
var _start = require('./views/start.jsx');

var _start2 = _interopRequireDefault(_start);

var _doc = require('./views/doc.jsx');

var _doc2 = _interopRequireDefault(_doc);

var _menu = require('./views/menu.jsx');
...
views.home = _home2.default;
views.start = _start2.default;
views.doc = _doc2.default;
...
window.App = {
    ...
    init: function init() {
        ...
        _reactDom2.default.render(_react2.default.createElement(_menu2.default, null), document.getElementById('nav'));
    ...
    setView: function setView(view, option) {
        ...
        setTimeout(function () {
            ...
            _reactDom2.default.unmountComponentAtNode(document.getElementById('wrapper'));
            _reactDom2.default.render(_react2.default.createElement(views[view], option ? { option: option } : null), document.getElementById('wrapper'));
            setTimeout(function () {
...
},{"./constants.js":3,"./views/doc.jsx":5,"./views/home.jsx":6,"./views/menu.jsx":7,"./views/start.jsx":8,"react":166,"react-dom":10}],2:[function(require,module,exports){
"use strict";

module.exports = Focus.Binder('Section', {

    getFromJson: function getFromJson(section, callback) {
        ...
        if (!App.cache[section]) {
            Focus.ajax({
                ...
                method: "GET",
                onSuccess: function onSuccess(xhr, data) {
    ...
    onData: function onData(data, callback) {
...
var Article = function (_React$Component) {
    ...
    function Article() {
        ...
        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Article).call(this));

        _this2.mainRegex = new RegExp(/(\n\n|\*\*(?:[\s\S]*?)\*\*|'''(?:[\s\S]*?)'''|\*\s(?:[\s\S]*?)\n)/g);
        _this2.titleRegex = new RegExp(/(?:\*\*([\s\S]*?)\*\*)/);
        _this2.codeRegex = new RegExp(/(?:'''([\s\S]*?)''')/);
        _this2.listRegex = new RegExp(/(?:\*\s(?:[\s\S]*?)\n)/);
        _this2.ul = [];
        _this2.state = {
            content: []
        };
    ...
    _createClass(Article, [{
        ...
        key: "formatText",
        value: function formatText(_text) {
            ...
            _text.forEach(function (_frag) {
                if (_this.codeRegex.test(_frag)) {
                    ...
                    if (_this.titleRegex.test(_frag)) _content.push({ type: "h2", value: _frag.match(_this.titleRegex)[1] });else if (_this.listRegex.test(_frag)) _content.push({ type: "li", value: _frag.replace('*', '') });else if (_frag !== "") _content.push({ type: "p", value: _frag });
                }
            });

            for (var i = 0, j = _content.length; i < j; ++i) {
        ...
        key: "renderText",
        value: function renderText(_tag, i) {
            switch (_tag.type) {

                case "p":
                    return _react2.default.createElement("p", { key: i, dangerouslySetInnerHTML: { __html: _tag.value.replace(/\n/g, "<br/>") } });
                    break;
...
var _SectionBinder = require('../binders/SectionBinder.js');

var _SectionBinder2 = _interopRequireDefault(_SectionBinder);

var _article2 = require('./article.jsx');
...
var Doc = function (_React$Component) {
    ...
    function Doc() {
        ...
        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Doc).call(this));
    ...
    _createClass(Doc, [{
        ...
        value: function componentDidMount() {
            ...
            var _this = this;
            (0, _SectionBinder2.default)(this, ['getFromJson']);
        ...
        key: 'getArticleFromUrl',
        value: function getArticleFromUrl(data, option) {
            ...
            return _react2.default.createElement(
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _cat.articles.map(function (_article, j) {
                                    ...
                                    return _react2.default.createElement(
                                        'li',
                                        { key: "category-" + i + "-article-" + j },
                                        _react2.default.createElement(
                                            'a',
                                            { onClick: _this.switchArticle.bind(_this, i, j) },
                                            _article.title
                                        )
                                    );
                                })
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_article3.default, { ref: 'article', htmlContent: this.state.article })
                    )
                )
            );
        }
        ...
        key: 'switchArticle',
        value: function switchArticle(categoryIndex, articleIndex) {
...
},{"../binders/SectionBinder.js":2,"./article.jsx":4,"react":166}],6:[function(require,module,exports){
'use strict';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('img', { src: 'img/logo-medium.png', alt: '', className: 'logo' }),
                        _react2.default.createElement(
                            'p',
                            { className: 'intro' },
                            'Focus.js is a front-end framework built to simplify single page application communication. It is an experimental framework that uses method binders as a means of making views and data communicate using clear cut separation of concerns.'
                        ),
                        _react2.default.createElement(
                            'ul',
                            { className: 'buttons' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_article2.default, { ref: 'article', htmlContent: this.state.content })
                    )
                )
            );
        }
...
},{"../binders/SectionBinder.js":2,"./article.jsx":4,"react":166}],7:[function(require,module,exports){
"use strict";
    ...
    _createClass(Menu, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "button",
                    { id: "menu-toggle", onClick: this.toggleMobileMenu.bind(this) },
                    "Menu"
                ),
                _react2.default.createElement(
                    "ul",
                    { className: this.state.menuToggled ? "menu-toggled" : "" },
                    _react2.default.createElement(
                        "li",
                        null,
                        _react2.default.createElement(
...
},{"../binders/SectionBinder.js":2,"./article.jsx":4,"react":166}],9:[function(require,module,exports){
